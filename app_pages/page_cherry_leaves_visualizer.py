...
def page_cherry_leaves_visualizer_body():
    ...
    st.info(
        ...
        f"differentiates a healthy leaf from a powdery mildew affected leaf.")
    ...
    if st.checkbox("Difference between average and variability image"):
        ...
        st.image(avg_powdery_mildew, caption='powdery mildew affected leaves - Average and Variability')
        st.write("---")
